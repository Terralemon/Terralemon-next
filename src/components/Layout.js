  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content="https://terralemon.nl/img/general/terralemon-twitter.jpg" />
        <meta property="og:type" content="website" />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:title" content={pageTitle} />
        <meta property="twitter:description" content={pageDescription} />
        <meta property="twitter:image" content="https://terralemon.nl/img/general/terralemon-twitter.jpg" />
      </Head>
      <Navbar />
      <main>
        {children}
